      ...
      module Processors
        class CompositeProcessor < BaseProcessor
          ...
          def on_send(node)
            ...
            if Jbuilder::CallDetectors::CacheCallDetector.cache_call?(receiver, method_name) || Jbuilder::CallDetectors::CacheCallDetector.cache_if_call?(receiver, method_name) || Jbuilder::CallDetectors::KeyFormatDetector.key_format?(receiver, method_name) || Jbuilder::CallDetectors::NullHandlingDetector.null_handling?(receiver, method_name) || Jbuilder::CallDetectors::ObjectManipulationDetector.object_manipulation?(receiver, method_name)
          ...
          def on_block(node)
            ...
            if Jbuilder::CallDetectors::CacheCallDetector.cache_call?(receiver, method_name) || Jbuilder::CallDetectors::CacheCallDetector.cache_if_call?(receiver, method_name)
